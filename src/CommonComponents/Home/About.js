          ...
          <Row>
            ...
            <Col className=" about-us">
              <p className="">
                ...
                investors converge to drive the future of innovation. <br />{" "}
                <br />
                Our mission is to empower creators by providing a platform where
                they can showcase their ideas and gain support from investors who
                believe in their potential. We strive to foster collaboration,
                transparency, and success through cutting-edge technology and a
                user-centric approach. <br /> <br />
                What sets us apart is our commitment to security, reliability, and
